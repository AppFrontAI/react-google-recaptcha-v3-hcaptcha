...
export declare function GoogleReCaptchaProvider({ reCaptchaKey, hcaptchaKey, provider, useEnterprise, useRecaptchaNet, scriptProps, language, container, children }: IGoogleReCaptchaProviderProps): JSX.Element;
