 ...
 * @returns
 */
export declare const injectGoogleReCaptchaScript: ({ render, onLoadCallbackName, language, onLoad, useRecaptchaNet, useEnterprise, scriptProps: { nonce, defer, async, id, appendTo, }, provider, }: IInjectGoogleReCaptchaScriptParams) => void;
/**
